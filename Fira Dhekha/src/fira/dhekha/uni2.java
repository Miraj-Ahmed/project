 ...
 * @author M-computers
 */
public class uni2 extends javax.swing.JFrame {

    /**
     * Creates new form uni2
     */
    public uni2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jSP, javax.swing.GroupLayout.DEFAULT_SIZE, 611, Short.MAX_VALUE)
        );
    ...
    private void jMI_OpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMI_OpenActionPerformed
        ...
        if(jfc.showOpenDialog(jMenu1)==JFileChooser.APPROVE_OPTION){
            //get selected file name[i.e.,completefile path]
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(uni2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
